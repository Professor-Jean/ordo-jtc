...
$json = SSP::complex( $_GET, $sql_details, $table, $primaryKey, $columns, $where);
$c = 0;
while($sellers_id = @$json["data"][$c]["sellers_id"]){
    $sql_select_sellers = "SELECT name FROM sellers WHERE id=".$sellers_id;

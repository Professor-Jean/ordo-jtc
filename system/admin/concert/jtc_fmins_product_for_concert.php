<?php
/**
 *Funcionalidade: este arquivo é destinado ao formulário de repasse de produto para conserto.
 *Data de criação: 19/11/2016
 */
?>
...
<div id="table_tabs">
    <ul>
        <li><a href="#tabs-1">Do Vendedor</a></li>
        <li><a href="#tabs-2">Do Estoque</a></li>
    </ul>
    <div>
        <div id="tabs-1">
            <div class="big_form">
                ...
                <table>
                    ...
                    <tbody class="removals">
                        <tr>
                            <td colspan="4">Selecione um vendedor</td>
                        </tr>
                    </tbody>
                </table>
            </div>
        ...
        <div id="tabs-2">
            <div class="big_form">
                <form name="entry_inventory" method="POST" onsubmit="return validate_form()" action="?folder=concert/&file=jtc_ins_product_for_concert&ext=php">
                    <div class="date">

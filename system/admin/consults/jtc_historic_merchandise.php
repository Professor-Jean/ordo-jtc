 ...
 */
?>
<h1 id="title-page">Histórico de Repasses de Mercadoria</h1>
...
<script>
  $(document).ready(function() {
    var dt = $('#x').DataTable( {
      ...
      "processing": true,
      "serverSide": true,
      "ajax": base_url+"addons/php/queries/jtc_passthrough_merchandise_queries.php",
      "columns": [
        {
...
<button type="button" id="button_grafic"><a href="?folder=consults/&file=jtc_devolutions_grafic_consults&ext=php">Gráfico de Devoluções <i class="fa fa-pie-chart" aria-hidden="true"></i></a></button>
<table id="x">
  <thead>
  <tr>
    <th></th>

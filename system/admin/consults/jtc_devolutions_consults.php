<?php
/**
 *Funcionalidade: este arquivo é destinado à Consulta de Devoluções.
 *Data de criação: 21/11/2016
 */
?>
<h1 id="title-page">Consulta de Devoluções</h1>
...
<script>
    ...
    $(document).ready(function() {
        var dt = $('#x').DataTable( {
            ...
            "processing": true,
            "serverSide": true,
            "ajax": base_url+"addons/php/queries/jtc_devolutions_queries.php",
            "columns": [
                {
